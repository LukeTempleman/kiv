...
#                    motion_sensor.close()
                    ...
                    sql = """
                    INSERT INTO device_data (D_Number, Serial, Start_date, End_date, Diagnostic, Code, Operator_Id, Bed_Id)
                    VALUES (CONCAT(%s, ' ', %s), %s, %s, %s, %s, %s, %s, %s)
                    """
                    values = (host_N, end_time, host_N, self.start_time, end_time, 'ok', reason, opID, shared.get_bedId())
